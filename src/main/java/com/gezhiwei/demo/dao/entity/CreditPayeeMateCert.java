...
public class CreditPayeeMateCert {
    ...
    public String getsMarryImg() {
        return sMarryImg;
    }

    public void setsMarryImg(String sMarryImg) {
        this.sMarryImg = sMarryImg == null ? null : sMarryImg.trim();
    }
